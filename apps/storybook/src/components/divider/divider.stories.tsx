...
import { createSeparatorA11yPlay, expectDataSlotVariant } from '../../lib/component-tests.ts';
...
export const Default: Story = {
  play: async (context) => {
    await createSeparatorA11yPlay()(context);
    await expectDataSlotVariant(context.canvasElement, { slot: 'divider', variant: 'horizontal' });
  },
};
...
export const Vertical: Story = {
  ...
  play: async (context) => {
    await createSeparatorA11yPlay()(context);
    await expectDataSlotVariant(context.canvasElement, { slot: 'divider', variant: 'vertical' });
  },
};
