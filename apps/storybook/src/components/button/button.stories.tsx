...
import { SIZES, VARIANTS, VariantSizeMatrixTable, VariantsTable } from './button-story-fixtures.tsx';
...
const meta = {
  ...
  argTypes: {
    ...
    iconPosition: selectArgType(['left', 'right'], 'Position of the icon relative to the label text.'),
