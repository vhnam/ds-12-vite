...
import "./pagination-DF2dUL-y.css";
...
const o = t(`ds-pagination`, {
    variants: {
      size: { sm: `ds-pagination--sm`, lg: `ds-pagination--lg` },
      layout: { centered: `ds-pagination--centered`, spread: `ds-pagination--spread`, end: null },
    },
    defaultVariants: { size: `lg`, layout: `centered` },
  }),
  s = t(`ds-pagination__button`, {
    variants: {
      size: { sm: `ds-pagination__button--sm`, lg: `ds-pagination__button--lg` },
      state: {
...
function c({ className: t, size: r, state: a, label: o, onClick: c, disabled: l, "aria-label": u, "aria-current": d }) {
  ...
  return n(i, {
    ...
    children: n(`span`, { className: `ds-pagination__label`, children: o }),
  });
}
function l({
  className: t,
  ...
  return _
    ? r(`nav`, {
        ...
        children: [
          ...
          n(`div`, { className: `ds-pagination__pages`, children: S }),
          n(c, {
            size: g,
    ...
    : n(`nav`, { className: e(o({ size: g, layout: `end`, className: t })), "aria-label": m, ...h, children: S });
}
